...
@Suite
struct MusicalMIDI1File_Decoding_Tests {
    ...
    func midiFileParse_AsyncSequence() async throws {
        actor Receiver {
            ...
            func addChunk(index: Int, chunk: MusicalMIDI1File.AnyChunk) {
                chunks[index] = chunk
            }
    ...
    func decodeOptions_allowMultiTrackFormat0() async throws {
        ...
        await #expect(throws: MIDIFileDecodeError.self) {
            ...
            _ = try await MusicalMIDI1File(data: rawData, options: options)
        }
    ...
    func decodeSpuriousBytesPastEOF_allowLossyRecovery() async throws {
        ...
        let garbageChunk: MusicalMIDI1File.AnyChunk = try #require(.undefined(identifier: "\u{43}\u{12}\u{01}\u{78}", data: Data()))
