...
@Suite
struct Data_MIDI1File_Tests {
    @Test
    func byteArray_init_midi1FileVariableLengthValue() {
    ...
    @Test
    func byteArray_midi1FileVariableLengthValue_Empty() {
        #expect(([] as [UInt8]).midi1FileVariableLengthValue() == nil)
    }

    @Test
    func byteArray_midi1FileVariableLengthValue() {
        // repeat the test for:
    ...
    @Test
    func data_midi1FileVariableLengthValue_data_pointer() throws {
        // 1 byte: max 7-bit value
    ...
    @Test
    func data_midi1FileVariableLengthValue_uInt8Array_pointer_slice() throws {
        // 1 byte: max 7-bit value
    ...
    @Test
    func byteArray_midi1FileVariableLengthValue_EdgeCase() {
