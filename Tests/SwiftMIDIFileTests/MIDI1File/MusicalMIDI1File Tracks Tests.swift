...
@Suite
struct MusicalMIDI1File_Tracks_Tests {
    @Test
    func tracksProperty_NoOtherChunksPresent() {
    ...
    @Test
    func tracksProperty_WithOtherChunksPresent() throws {
        let trackA = MusicalMIDI1File.Track(events: [
            .noteOn(note: 60, velocity: .midi1(64))
        ])
        ...
        let chunkA = try MusicalMIDI1File.UndefinedChunk(identifier: #require(.undefined(identifier: "ABCD")), data: Data([0x01]))
        let chunkB = try MusicalMIDI1File.UndefinedChunk(identifier: #require(.undefined(identifier: "EFGH")), data: Data([0x02, 0x03]))
    ...
    @Test
    func initialTempo_oneTrack_emptyTrack() {
    ...
    @Test
    func initialTempo_oneTrack_eventsWithoutTempo() {
    ...
    @Test
    func initialTempo_oneTrack_eventsWithTempoAtStart() {
        let events: [MusicalMIDI1File.Track.Event] = [
            .keySignature(delta: .none, key: .bMajor),
            .timeSignature(delta: .none, numerator: 2, denominator: 2),
    ...
    @Test
    func initialTempo_oneTrack_eventsWithTempoAfterStart() {
        let events: [MusicalMIDI1File.Track.Event] = [
            .keySignature(delta: .none, key: .bMajor),
            .timeSignature(delta: .none, numerator: 2, denominator: 2),
            .cc(delta: .note8th, controller: 1, value: .midi1(127), channel: 0),
    ...
    @Test
    func initialTempo_oneTrack_eventsWithMultipleTempoEvents() {
        let events: [MusicalMIDI1File.Track.Event] = [
            .keySignature(delta: .none, key: .bMajor),
            .timeSignature(delta: .none, numerator: 2, denominator: 2),
    ...
    @Test
    func initialTempo_multipleTracks_eventsWithMultipleTempoEvents() {
