...
@Suite
struct Musical_DeltaTime_Tests {
    ...
    @Test
    func musicalStaticConstructors_240ppq() {
    ...
    @Test
    func musicalStaticConstructors_480ppq() {
        typealias Delta = MusicalMIDI1File.Track.DeltaTime
    ...
    @Test
    func musicalStaticConstructors_960ppq() {
        typealias Delta = MusicalMIDI1File.Track.DeltaTime
    ...
    @Test
    func musicalStaticConstructors_beats() {
        typealias Delta = MusicalMIDI1File.Track.DeltaTime
        let timebase: Delta.Timebase = .musical(ticksPerQuarterNote: 480)
    ...
    @Test
    func musicalStaticConstructors_edgeCases() {
        typealias Delta = MusicalMIDI1File.Track.DeltaTime
