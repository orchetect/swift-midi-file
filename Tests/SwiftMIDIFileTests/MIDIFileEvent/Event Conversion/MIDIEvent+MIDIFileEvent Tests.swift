...
@Suite
struct MIDIEvent_to_MIDIFileEvent_Tests {
    @Test
    func midi_Event_NoteOn_midiFileEvent() {
    ...
    @Test
    func midi_Event_NoteOff_midiFileEvent() {
    ...
    @Test
    func midi_Event_NoteCC_midiFileEvent() {
    ...
    @Test
    func midi_Event_NotePitchBend_midiFileEvent() {
    ...
    @Test
    func midi_Event_NotePressure_midiFileEvent() {
    ...
    @Test
    func midi_Event_NoteManagement_midiFileEvent() {
    ...
    @Test
    func midi_Event_CC_midiFileEvent() {
    ...
    @Test
    func midi_Event_ProgramChange_midiFileEvent() {
    ...
    @Test
    func midi_Event_RPN_midiFileEvent() {
    ...
    @Test
    func midi_Event_NRPN_midiFileEvent() {
    ...
    @Test
    func midi_Event_PitchBend_midiFileEvent() {
    ...
    @Test
    func midi_Event_Pressure_midiFileEvent() {
