...
enum kMIDI1File {
    ...
    static let dp8Markers: [UInt8] = [
        ...
        0x00,                   // delta time
        0xFF, 0x03, 0x05, 0x53, // track name
        0x65, 0x71, 0x2D, 0x31,
        0x00,                   // delta time
        0xFF, 0x54, 0x05, 0x40, // SMPTE offset
        0x00, 0x00, 0x00, 0x00,
        0x00,                   // delta time
        0xFF, 0x58, 0x04, 0x04, // time signature
        0x02, 0x18, 0x08,
        0x00,                   // delta time
        0xFF, 0x51, 0x03, 0x07, // tempo
        0xA1, 0x20,
        // marker
        ...
        0x00,                   // delta time
        0xFF, 0x03, 0x06, 0x4D, // track name
        0x49, 0x44, 0x49, 0x2D,
        0x31,
        0x81, 0xD3, 0x8E, 0x77, // delta time
        0x90, 0x3B, 0x40,       // note on
        0x86, 0x60,             // delta time
        ...
        0x32,
        0x00,                   // delta time
        0xFF, 0x20, 0x01, 0x00, // channel prefix: chan 0
        0x00,
        0xFF, 0x2F, 0x00 // end of track
    ]
    ...
    static let customChunk: [UInt8] = [
        ...
        0x00,                   // delta time
        0xFF, 0x03, 0x05, 0x50, // track name, 5 bytes, "Piano"
        0x69, 0x61, 0x6E, 0x6F,
        0x00,                   // delta time
        0xFF, 0x04, 0x10, 0x53, // instrument name, 0x10 (16) bytes, "Steinway Piano 2"
        0x74, 0x65, 0x69, 0x6E,
        0x77, 0x61, 0x79, 0x20,
        0x50, 0x69, 0x61, 0x6E,
        0x6F, 0x20, 0x32,
        ...
        0x02, 0x18, 0x08,
        0x00,                   // delta time
        0xFF, 0x59, 0x02, 0x00, // key signature
        0x00,
        0x00,                   // delta time
        0xFF, 0x54, 0x05, 0x60, // SMPTE offset
        0x00, 0x00, 0x00, 0x00,
        0x00,                   // delta time
        0xFF, 0x51, 0x03, 0x07, // tempo
        0xA1, 0x1F,
    ...
    static let smpte: [UInt8] = [
        ...
        0x93, 0x44,             // delta time
        0xB0, 0x02, 0x46,       // cc
        0x83, 0x74,             // delta time
        0xB0, 0x02, 0x4B,       // cc
        0x00,                   // delta time
        0xFF, 0x2F, 0x00,       // end of track
