...
public struct MIDI1FileDecodeOptions {
    ...
    public init(
        ...
        chunkDecodeOptions: MIDI1FileChunkDecodeOptions = .init()
    ) {
...
extension MIDI1FileDecodeOptions: Equatable { }

extension MIDI1FileDecodeOptions: Hashable { }

extension MIDI1FileDecodeOptions: Sendable { }
