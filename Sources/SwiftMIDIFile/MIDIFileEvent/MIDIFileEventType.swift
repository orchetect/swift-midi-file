...
extension MIDIFileEventType {
    ...
    public var concreteType: any MIDIFileEventPayload.Type {
        ...
        case .tempo:              MIDIFileEvent.AnyTempo.self
...
extension Collection<MIDIFileEventType> {
    ...
    public var concreteTypes: [any MIDIFileEventPayload.Type] {
...
extension MIDIFileEventType {
    ...
    private static func eventType(
        ...
        case let d where d.starts(with: MIDIFileEvent.AnyTempo.prefixBytes): return .tempo
